...
export default function TopChannel() {
  ...
  return (
    <div className="rounded-2xl border border-gray-200 bg-white p-4 md:p-6 dark:border-gray-800 dark:bg-white/[0.03]">
      ...
      <a
        href="#"
        className="text-theme-sm shadow-theme-xs flex justify-center gap-2 rounded-lg border border-gray-300 bg-white p-2.5 font-medium text-gray-700 hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-white/[0.03]"
      >
        Channels Report
        <svg
