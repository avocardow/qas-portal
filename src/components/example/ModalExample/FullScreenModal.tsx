...
export default function FullScreenModal() {
  ...
  return (
    <ComponentCard title="Full Screen Modal">
      ...
      >
        <div className="fixed left-0 top-0 flex h-screen w-full flex-col justify-between overflow-y-auto overflow-x-hidden bg-white p-6 lg:p-10 dark:bg-gray-900">
          <div>
