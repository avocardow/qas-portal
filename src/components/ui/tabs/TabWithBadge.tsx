...
const TabButton: React.FC<{
  ...
  >
    {tab.label}
    {tab.count !== undefined && (
      <span className="bg-brand-50 text-brand-500 dark:bg-brand-500/15 dark:text-brand-400 inline-block items-center justify-center rounded-full px-2 py-0.5 text-center text-xs font-medium">
        {tab.count}
      </span>
    )}
  </button>
