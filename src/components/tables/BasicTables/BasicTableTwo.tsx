  ...
  return (
    <div className="overflow-hidden rounded-2xl border border-gray-200 bg-white pt-4 dark:border-white/[0.05] dark:bg-white/[0.03]">
      ...
      <div className="max-w-full overflow-x-auto">
        <Table>
          <TableHeader className="border-y border-gray-100 bg-gray-50 px-6 py-3.5 dark:border-white/[0.05] dark:bg-gray-900">
            <TableRow>
            ...
            {tableRowData.map((row: TableRowData) => (
              <TableRow key={row.id}>
                ...
                <TableCell className="px-4 py-3.5 sm:px-6">
                  {row.actions.delete && (
                    <button>
                      <TrashBinIcon className="hover:text-error-500 dark:hover:text-error-500 cursor-pointer fill-gray-700 dark:fill-gray-400" />
                    </button>
                  )}
                </TableCell>
              </TableRow>
