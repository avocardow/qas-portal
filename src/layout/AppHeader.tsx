...
const AppHeader: React.FC = () => {
  ...
  // Show the impersonation dropdown if user can impersonate or is currently impersonating
  const showImpersonationDropdown = canUseImpersonation || Boolean(impersonatedRole);
  ...
  const { data: searchResults } = api.search.searchClients.useQuery(globalSearchTerm, { enabled: globalSearchTerm.length > 0 });
    ...
    <header className="sticky top-0 z-99999 flex w-full border-gray-200 bg-white transition-colors duration-300 ease-in-out lg:border-b dark:border-gray-800 dark:bg-gray-900">
      <div className="flex grow flex-col items-center justify-between lg:flex-row lg:px-6">
        <div className="flex w-full items-center justify-between gap-2 border-b border-gray-200 p-3 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4 dark:border-gray-800">
          <button
            className="z-99999 size-10 items-center justify-center rounded-lg border-gray-200 text-gray-500 lg:flex lg:size-11 lg:border dark:border-gray-800 dark:text-gray-400"
          ...
          <Link href="/clients" className="lg:hidden">
            <Image
              width={154}
              height={32}
          ...
          <div className="hidden lg:block w-[430px]">
            <div className="relative">
              ...
              <input
                ...
                className="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 h-11 w-full rounded-lg border border-gray-200 bg-transparent py-2.5 pr-14 pl-12 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden"
              />
              {globalSearchTerm && (
                <button
              ...
              {searchResults && searchResults.length > 0 && (
                <div className="absolute mt-1 w-full bg-white border border-gray-300 rounded shadow-lg z-50 max-h-60 overflow-auto dark:bg-gray-900">
